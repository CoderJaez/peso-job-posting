            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-sm-9 col-sm-offset-1">
                        ...
                        <div class="form-group">
                            <label class="form-control-label text-right col-sm-4">Referred placemerit</label>
                            <div class="col-sm-8">
                                <select name="placemerit" class="form-control">
                                    <option selected="true" value="" disabled>SELECT PLACEMERIT</option>
                                    <?php foreach ($placemerits as $key => $row) : ?>
                                    <?php echo '<option value="' . $row . '">' . strtoupper($row) . '</option>' ?>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="form-control-label text-right col-sm-4">Company /
                                Establishment:</label>
                            <div class="col-sm-8"><select name="company" class="form-control">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-default" id="btnCancelHiredApplicant">Cancel</button>
                </div>
                <?= form_close(); ?>
            </div>
